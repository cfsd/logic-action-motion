...
int32_t main(int32_t argc, char **argv) {
    ...
    if ((0 == commandlineArguments.count("cid")) || (0 == commandlineArguments.count("verbose"))) {
        ...
        std::cerr << "Example: " << argv[0] << " --cid=111 --cidSM --id=1 --verbose=1" << std::endl;
        retCode = 1;
    } else {
        ...
        cluon::OD4Session od4SM{static_cast<uint16_t>(std::stoi(commandlineArguments["cidSM"]))};

        Motion motion(VERBOSE, ID, od4SM);
